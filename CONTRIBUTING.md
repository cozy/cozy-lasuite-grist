# How to contribute to  cozy-lasuite-grist?
...
- What is the version of the  cozy-lasuite-grist app?
...
```
$ git clone github.com/cozy/ cozy-lasuite-grist.git
$ cd  cozy-lasuite-grist
$ git remote add fork git://github.com/yourusername/ cozy-lasuite-grist.git
```
...
Go to https://github.com/yourusername/ cozy-lasuite-grist and select your branch. Click the 'Pull Request' button and fill out the form.
...
The  cozy-lasuite-grist is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/ cozy-lasuite-grist/issues/new
...
[localization]: https://github.com/cozy/ cozy-lasuite-grist/blob/master/README.md#localization
